...
type
  ...
  published
    ...
    [TDBField('Data Situação', [ dbUpdate])]
    ...
    [TDBField('Descrição Estado', [dbForeign], True, 'U', 'ESTADO', '', 'NOME')]
    ...
    [TDBField('Número', [ dbUpdate])]
    property NUMERO: String read FNUMERO write FNUMERO;
    [TDBField('CEP', [ dbUpdate])]
    property CEP: String read FCEP write FCEP;
    [TDBField('Município', [ dbUpdate])]
    ...
    [TDBField('Natureza Jurídica', [ dbUpdate])]
    ...
    [TDBField('Situação Especial', [ dbUpdate])]
